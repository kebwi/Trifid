...
#include "fftlib.h"
#include <math.h>
#define	MCACHE	(11-(sizeof(Float_t)/8))	// fft's with M bigger than this bust primary cache
...
void fftCosInit(long M, Float_t *Utbl){
...
inline void bitrevR2(Float_t *ioptr, long M, short *BRLow);
inline void bitrevR2(Float_t *ioptr, long M, short *BRLow){
...
inline void fft2pt(Float_t *ioptr);
inline void fft2pt(Float_t *ioptr){
/***   RADIX 2 fft	***/
Float_t f0r, f0i, f1r, f1i;
Float_t t0r, t0i;
...
inline void fft4pt(Float_t *ioptr);
inline void fft4pt(Float_t *ioptr){
/***   RADIX 4 fft	***/
Float_t f0r, f0i, f1r, f1i, f2r, f2i, f3r, f3i;
Float_t t0r, t0i, t1r, t1i;
...
inline void fft8pt(Float_t *ioptr);
inline void fft8pt(Float_t *ioptr){
/***   RADIX 8 fft	***/
Float_t w0r = 1.0/MYROOT2; /* cos(pi/4)	*/
Float_t f0r, f0i, f1r, f1i, f2r, f2i, f3r, f3i;
Float_t f4r, f4i, f5r, f5i, f6r, f6i, f7r, f7i;
Float_t t0r, t0i, t1r, t1i;
...
inline void bfR2(Float_t *ioptr, long M, long NDiffU);
inline void bfR2(Float_t *ioptr, long M, long NDiffU){
/*** 2nd radix 2 stage ***/
unsigned long	pos;
unsigned long	posi;
...
inline void bfR4(Float_t *ioptr, long M, long NDiffU);
inline void bfR4(Float_t *ioptr, long M, long NDiffU){
/*** 1 radix 4 stage ***/
unsigned long	pos;
unsigned long	posi;
...
Float_t w1r = 1.0/MYROOT2; /* cos(pi/4)	*/
Float_t f0r, f0i, f1r, f1i, f2r, f2i, f3r, f3i;
Float_t f4r, f4i, f5r, f5i, f6r, f6i, f7r, f7i;
Float_t t1r, t1i;
const Float_t Two = 2.0;
...
inline void bfstages(Float_t *ioptr, long M, Float_t *Utbl, long Ustride, long NDiffU, long StageCnt);
inline void bfstages(Float_t *ioptr, long M, Float_t *Utbl, long Ustride, long NDiffU, long StageCnt){
/***   RADIX 8 Stages	***/
unsigned long	pos;
unsigned long	posi;
...
Float_t	*pstrt;
Float_t 	*p0r, *p1r, *p2r, *p3r;
Float_t 	*u0r, *u0i, *u1r, *u1i, *u2r, *u2i;

Float_t w0r, w0i, w1r, w1i, w2r, w2i, w3r, w3i;
Float_t f0r, f0i, f1r, f1i, f2r, f2i, f3r, f3i;
Float_t f4r, f4i, f5r, f5i, f6r, f6i, f7r, f7i;
Float_t t0r, t0i, t1r, t1i;
const Float_t Two = 2.0;
...
void fftrecurs(Float_t *ioptr, long M, Float_t *Utbl, long Ustride, long NDiffU, long StageCnt);
void fftrecurs(Float_t *ioptr, long M, Float_t *Utbl, long Ustride, long NDiffU, long StageCnt){
...
void ffts1(Float_t *ioptr, long M, long Rows, Float_t *Utbl, short *BRLow){
...
inline void scbitrevR2(Float_t *ioptr, long M, short *BRLow, Float_t scale);
inline void scbitrevR2(Float_t *ioptr, long M, short *BRLow, Float_t scale){
...
inline void ifft2pt(Float_t *ioptr, Float_t scale);
inline void ifft2pt(Float_t *ioptr, Float_t scale){
/***   RADIX 2 ifft	***/
Float_t f0r, f0i, f1r, f1i;
Float_t t0r, t0i;
...
inline void ifft4pt(Float_t *ioptr, Float_t scale);
inline void ifft4pt(Float_t *ioptr, Float_t scale){
/***   RADIX 4 ifft	***/
Float_t f0r, f0i, f1r, f1i, f2r, f2i, f3r, f3i;
Float_t t0r, t0i, t1r, t1i;
...
inline void ifft8pt(Float_t *ioptr, Float_t scale);
inline void ifft8pt(Float_t *ioptr, Float_t scale){
/***   RADIX 8 ifft	***/
Float_t w0r = 1.0/MYROOT2; /* cos(pi/4)	*/
Float_t f0r, f0i, f1r, f1i, f2r, f2i, f3r, f3i;
...
inline void ibfR2(Float_t *ioptr, long M, long NDiffU);
inline void ibfR2(Float_t *ioptr, long M, long NDiffU){
/*** 2nd radix 2 stage ***/
unsigned long	pos;
unsigned long	posi;
...
inline void ibfR4(Float_t *ioptr, long M, long NDiffU);
inline void ibfR4(Float_t *ioptr, long M, long NDiffU){
/*** 1 radix 4 stage ***/
unsigned long	pos;
unsigned long	posi;
...
inline void ibfstages(Float_t *ioptr, long M, Float_t *Utbl, long Ustride, long NDiffU, long StageCnt);
inline void ibfstages(Float_t *ioptr, long M, Float_t *Utbl, long Ustride, long NDiffU, long StageCnt){
/***   RADIX 8 Stages	***/
unsigned long	pos;
unsigned long	posi;
...
void ifftrecurs(Float_t *ioptr, long M, Float_t *Utbl, long Ustride, long NDiffU, long StageCnt);
void ifftrecurs(Float_t *ioptr, long M, Float_t *Utbl, long Ustride, long NDiffU, long StageCnt){
/* recursive bfstages calls to maximize on chip cache efficiency */
long i1;
if (M <= MCACHE)
...
void iffts1(Float_t *ioptr, long M, long Rows, Float_t *Utbl, short *BRLow){
...
long 	StageCnt;
long 	NDiffU;
const Float_t scale = 1.0/POW2(M);
...
inline void rfft1pt(Float_t *ioptr);
inline void rfft1pt(Float_t *ioptr){
/***   RADIX 2 rfft	***/
Float_t f0r, f0i;
Float_t t0r, t0i;
...
inline void rfft2pt(Float_t *ioptr);
inline void rfft2pt(Float_t *ioptr){
/***   RADIX 4 rfft	***/
Float_t f0r, f0i, f1r, f1i;
Float_t t0r, t0i;
...
inline void rfft4pt(Float_t *ioptr);
inline void rfft4pt(Float_t *ioptr){
/***   RADIX 8 rfft	***/
Float_t f0r, f0i, f1r, f1i, f2r, f2i, f3r, f3i;
Float_t t0r, t0i, t1r, t1i;
...
inline void rfft8pt(Float_t *ioptr);
inline void rfft8pt(Float_t *ioptr){
/***   RADIX 16 rfft	***/
Float_t w0r = 1.0/MYROOT2; /* cos(pi/4)	*/
Float_t w1r = MYCOSPID8; /* cos(pi/8)	*/
Float_t w1i = MYSINPID8; /* sin(pi/8)	*/
Float_t f0r, f0i, f1r, f1i, f2r, f2i, f3r, f3i;
Float_t f4r, f4i, f5r, f5i, f6r, f6i, f7r, f7i;
Float_t t0r, t0i, t1r, t1i;
const Float_t Two = 2.0;
...
inline void frstage(Float_t *ioptr, long M, Float_t *Utbl);
inline void frstage(Float_t *ioptr, long M, Float_t *Utbl){
/*	Finish RFFT		*/
...
Float_t w0r, w0i;
Float_t f0r, f0i, f1r, f1i, f4r, f4i, f5r, f5i;
Float_t t0r, t0i, t1r, t1i;
const Float_t Two = 2.0;
...
void rffts1(Float_t *ioptr, long M, long Rows, Float_t *Utbl, short *BRLow){
...
inline void rifft1pt(Float_t *ioptr, Float_t scale);
inline void rifft1pt(Float_t *ioptr, Float_t scale){
/***   RADIX 2 rifft	***/
Float_t f0r, f0i;
Float_t t0r, t0i;
...
inline void rifft2pt(Float_t *ioptr, Float_t scale);
inline void rifft2pt(Float_t *ioptr, Float_t scale){
/***   RADIX 4 rifft	***/
Float_t f0r, f0i, f1r, f1i;
Float_t t0r, t0i;
...
inline void rifft4pt(Float_t *ioptr, Float_t scale);
inline void rifft4pt(Float_t *ioptr, Float_t scale){
/***   RADIX 8 rifft	***/
Float_t f0r, f0i, f1r, f1i, f2r, f2i, f3r, f3i;
Float_t t0r, t0i, t1r, t1i;
...
inline void rifft8pt(Float_t *ioptr, Float_t scale);
inline void rifft8pt(Float_t *ioptr, Float_t scale){
/***   RADIX 16 rifft	***/
Float_t w0r = 1.0/MYROOT2; /* cos(pi/4)	*/
Float_t w1r = MYCOSPID8; /* cos(pi/8)	*/
...
inline void ifrstage(Float_t *ioptr, long M, Float_t *Utbl);
inline void ifrstage(Float_t *ioptr, long M, Float_t *Utbl){
/*	Start RIFFT		*/
...
void riffts1(Float_t *ioptr, long M, long Rows, Float_t *Utbl, short *BRLow){
